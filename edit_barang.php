                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <?php 
                                            ...
                                            $kdBrg = $_GET['kdBrg'];
                                            $tsql = "SELECT * FROM Barang WHERE kdBrg='$kdBrg'";
				                        ...
				                        ?>
                                            <form method="post" action="crud/action_update_barang.php">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">Kode Barang</label>
                                                            <input name="kdBrg" type="text" class="form-control" value="<?php echo $d['kdBrg']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="jenis" value="<?php echo $d['jenis']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <select name="kondisi" id="inputState" class="form-control">
                                                        ...
                                                        <option <?=$d['kondisi'] == 'Baik' ? ' selected="selected"' : '';?>>Baik</option>
                                                        <option <?=$d['kondisi'] == 'Rusak' ? ' selected="selected"' : '';?>>Rusak</option>
                                                    </select>
                                                </div>
                                                </br>
