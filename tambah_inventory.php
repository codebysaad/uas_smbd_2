            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Inventory Baru</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form method="post" action="crud/action_tambah_inventory.php">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">NUP</label>
                                                            <input name="nup" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-8">
                                                        <label for="inputState">Pilih Barang</label>
                                                        <select name="kdBrg" id="inputState" class="form-control">
                                                ...
                                                <div class="row">
                                                <div class="form-group col-md-8">
                                                        <label for="inputState">Pilih PIC</label>
